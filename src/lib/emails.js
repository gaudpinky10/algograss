...
<div style="max-width:640px;margin:0 auto;background:#060B14">
  ...
  <div style="padding:20px 40px;border-top:1px solid #1e2d45;text-align:center">
    <p style="color:#475569;font-size:11px;margin:0;line-height:1.7">
      AlgoGrass · Automated GDPR Compliance · <a href="https://www.algograss.co.uk" style="color:#00D4AA;text-decoration:none">algograss.co.uk</a><br>
  ...
  const html = layout(`
    ...
    <div style="padding:32px 40px;background:#060B14">
      ...
      <div style="background:#0D1525;border:1px solid #1e2d45;border-radius:12px;overflow:hidden;margin-bottom:24px">
        ${[
          ['🔍', 'Scan your website', 'Get your real-time GDPR compliance score — instant results.', 'https://www.algograss.co.uk/scan'],
          ['📄', 'Generate documents', 'Auto-generate your Privacy Policy, Cookie Notice & DPA from your scan.', 'https://www.algograss.co.uk/generate'],
          ['🤖', 'Ask AlgoGrass AI', 'Get instant answers to any GDPR or UK data protection question.', 'https://www.algograss.co.uk/ai-chat'],
          ['📋', 'Set up your GRC', 'Build your GDPR compliance register and track your obligations.', 'https://www.algograss.co.uk/grc'],
      ...
      <div style="background:linear-gradient(135deg,rgba(0,212,170,0.08),rgba(124,158,255,0.08));border:1px solid rgba(0,212,170,0.2);border-radius:12px;padding:24px;text-align:center">
        ...
        ${btn('Start 30-day free trial', 'https://www.algograss.co.uk/pricing')}
      </div>` : `
      <div style="background:linear-gradient(135deg,rgba(0,212,170,0.08),rgba(124,158,255,0.08));border:1px solid rgba(0,212,170,0.2);border-radius:12px;padding:24px;text-align:center">
        <p style="color:#00D4AA;font-size:14px;font-weight:600;margin:0 0 16px">✅ Pro plan active — all automations enabled</p>
        ${btn('Go to dashboard', 'https://www.algograss.co.uk/dashboard')}
      </div>`}
    </div>
  ...
  const html = layout(`
    ...
    <div style="padding:28px 40px;background:#060B14">
      ...
      <div style="text-align:center;margin-top:24px">
        ${btn('View full report & fix issues', 'https://www.algograss.co.uk/scan')}
      </div>
    </div>
  ...
  const html = layout(`
    ...
    <div style="padding:32px 40px;background:#060B14">
      ...
      <div style="text-align:center">
        ${btn('Upgrade now — keep full access', 'https://www.algograss.co.uk/pricing')}
...
export async function sendTrialExpiredEmail(name, email) {
  ...
  const html = layout(`
    ...
    <div style="padding:32px 40px;background:#060B14">
      ...
      <div style="text-align:center">
        ${btn('Reactivate Pro — from £29/mo', 'https://www.algograss.co.uk/pricing')}
...
export async function sendRegulatoryAlertEmail(name, email, updates) {
  ...
  const html = layout(`
    ...
    <div style="padding:28px 40px;background:#060B14">
      ...
      <div style="text-align:center">
        ${btn('View full regulatory monitor', 'https://www.algograss.co.uk/regulatory')}
      </div>
    </div>
