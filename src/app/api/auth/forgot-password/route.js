...
export async function POST(request) {
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;background:#060B14;color:#E8F0FE;padding:40px 32px;border-radius:16px">
          <div style="text-align:center;margin-bottom:28px">
            <span style="font-size:32px">🔒</span>
            <h1 style="font-size:22px;font-weight:800;color:#00D4AA;margin:12px 0 4px">Password Reset</h1>
          ...
          <p style="font-size:14px;color:#94A3B8;margin-bottom:24px">We received a request to reset your password. Click the button below to set a new password. This link expires in <strong style="color:#E8F0FE">1 hour</strong>.</p>
          <div style="text-align:center;margin-bottom:24px">
            <a href="${resetLink}" style="display:inline-block;background:#00D4AA;color:#060B14;font-weight:700;font-size:15px;padding:14px 36px;border-radius:10px;text-decoration:none">Reset my password →</a>
          </div>
