    ...
    <div style={page}>
      <div style={wrap}>
        ...
        <div style={{ ...card, textAlign: 'center', background: 'linear-gradient(135deg,rgba(139,92,246,0.06),rgba(124,158,255,0.06))' }}>
          ...
          <a href="https://www.algograss.com/signup" style={{ display: 'inline-block', background: 'linear-gradient(135deg,#9B7BFA,#7C3AED)', color: '#06060F', fontWeight: 700, fontSize: 14, padding: '12px 28px', borderRadius: 10, textDecoration: 'none' }}>Get your free account →</a>
