    ...
    <nav style={{
      ...
      <a href="/" style={{ textDecoration: 'none' }}>
        <span style={{
          ...
          <svg width="26" height="30" viewBox="0 0 32 36" fill="none">
            ...
            <path d="M16 0 L32 6 L32 20 Q32 30 16 36 Q0 30 0 20 L0 6 Z" fill="url(#logoGrad)" opacity="0.9"/>
      ...
      <ul style={{ display: 'flex', alignItems: 'center', gap: 4, listStyle: 'none' }}>
        ...
        <li ref={menuRef} style={{ position: 'relative' }}>
          ...
          {toolsOpen && (
            <div style={{
              ...
              {TOOLS.map(t => (
                <a key={t.href} href={t.href} onClick={() => setToolsOpen(false)}
                  style={{
                    display: 'flex', alignItems: 'flex-start', gap: 12,
                    padding: '10px 12px', borderRadius: 10, textDecoration: 'none',
                    background: path === t.href ? 'rgba(0,212,170,0.08)' : 'transparent',
        ...
        <li style={{ marginLeft: 8 }}>
          <a href="/login" style={{
            fontSize: 14, color: 'rgba(232,240,254,0.6)', padding: '6px 12px', borderRadius: 8,
            transition: 'color .2s',
          }}
        ...
        <li style={{ marginLeft: 4 }}>
          <a href="/signup" style={{
            ...
            boxShadow: '0 0 18px rgba(0,212,170,0.25)',
            transition: 'all .2s',
          }}
