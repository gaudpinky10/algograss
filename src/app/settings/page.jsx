        ...
        {tab === 'Security' && (
          <>
            ...
            <div style={S.card}>
              ...
              <button style={S.btnDanger} onClick={() => confirm('Are you absolutely sure? All your data will be deleted.') && alert('Please email contact@algograss.com to delete your account.')}>Delete My Account</button>
            </div>
          </>
        )}
      </div>
