      ...
      <div className="wrap" style={{ maxWidth: 780 }}>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ background: 'rgba(139,92,246,0.06)', border: '1px solid rgba(139,92,246,0.15)', borderRadius: 10, padding: '14px 18px', marginTop: 20 }}>
            <p style={{ margin: 0, fontSize: 13, color: '#9B7BFA' }}>This policy explains what cookies AlgoGrass uses, why, and how you can control them — in compliance with the Privacy and Electronic Communications Regulations (PECR) and UK GDPR.</p>
          </div>
        </div>
        ...
        <Section title="2. Cookies we use">
          <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden', marginBottom: 16 }}>
            {/* Header row */}
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1.5fr 2fr', gap: 12, padding: '12px 16px', background: 'rgba(139,92,246,0.06)', fontSize: 11, fontWeight: 700, color: 'var(--green)', textTransform: 'uppercase', letterSpacing: '.06em' }}>
            ...
            {[
              ...
              <div key={name} style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1.5fr 2fr', gap: 12, padding: '12px 16px', borderTop: '1px solid var(--border)', fontSize: 12 }}>
                ...
                <span style={{
                  color: type === 'Essential' ? '#9B7BFA' : '#818CF8',
                  fontWeight: 600,
                }}>{type}</span>
        ...
        <Section title="5. What we do NOT do">
          {[
            ...
            <div key={item} style={{ paddingLeft: 14, borderLeft: '2px solid rgba(139,92,246,0.3)', marginBottom: 10, fontSize: 13 }}>✅ {item}</div>
          ))}
        </Section>
