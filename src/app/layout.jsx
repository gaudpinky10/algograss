...
export const metadata = {
  metadataBase: new URL('https://www.algograss.com'),
  title: {
  ...
  authors: [{ name: 'AlgoGrass', url: 'https://www.algograss.com' }],
  creator: 'AlgoGrass',
  publisher: 'AlgoGrass',
  ...
  alternates: { canonical: 'https://www.algograss.com' },
}
