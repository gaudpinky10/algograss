const POSTS=[
  {slug:'gdpr-for-saas',cat:'GDPR',date:'18 Jun 2026',read:'12 min',title:'GDPR for SaaS Founders: Data Protection by Design',excerpt:'Building a SaaS product means building a data processing business. Here is how to get data protection right from day one — before it becomes a costly retrofit.'},
  {slug:'ico-enforcement-2025',cat:'Compliance',date:'5 Jun 2026',read:'9 min',title:'ICO Enforcement in 2025–26: Key Lessons for UK SMEs',excerpt:'The ICO continues to fine businesses of all sizes — and size is no defence. These are the patterns in recent enforcement actions and what UK businesses can learn.'},
  {slug:'eu-ai-act-guide',cat:'AI Act',date:'22 May 2026',read:'11 min',title:'EU AI Act: What UK Businesses Need to Know in 2026',excerpt:'The world\'s first comprehensive AI regulation is now in full effect. If you deploy AI tools to EU customers, it applies to you. Here\'s what you need to do.'},
  {slug:'gdpr-checklist-2025',cat:'GDPR',date:'10 Apr 2026',read:'8 min',title:'The 2026 GDPR Compliance Checklist for UK SMEs',excerpt:'Everything your small business needs to do to be GDPR compliant — explained in plain English without the legal jargon.'},
  {slug:'cookie-banner-guide',cat:'Cookies',date:'28 Mar 2026',read:'6 min',title:'How to Set Up a Legally Compliant Cookie Banner',excerpt:'Cookie banners are not optional under UK and EU law. Here is exactly what yours must say and the mistakes to avoid.'},
  {slug:'privacy-policy-requirements',cat:'GDPR',date:'14 Mar 2026',read:'10 min',title:'What Must Be in Your Privacy Policy Under GDPR',excerpt:'GDPR Articles 13 and 14 set out exactly what your privacy policy must include. We break down every requirement.'},
  {slug:'ico-fines-guide',cat:'Compliance',date:'5 Mar 2026',read:'7 min',title:'Understanding ICO Fines: What Gets UK Businesses Fined?',excerpt:'The ICO has fined small businesses as well as large corporations. Learn what triggers an investigation.'},
  {slug:'data-processing-agreement',cat:'GDPR',date:'20 Feb 2026',read:'5 min',title:'When Does Your Business Need a Data Processing Agreement?',excerpt:'If you use third-party tools that process customer data, you likely need a DPA. Here is what it must contain.'},
...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.algograss.co.uk/blog',
  },
}
