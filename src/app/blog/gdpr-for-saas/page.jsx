...
const Req=({title,desc})=><div style={{background:'rgba(15,23,42,0.03)',border:'1px solid rgba(15,23,42,0.09)',borderRadius:12,padding:'18px 20px',marginBottom:12}}><div style={{fontSize:13,fontWeight:700,color:'var(--accent)',marginBottom:8}}>{title}</div><p style={{fontSize:13,color:'var(--ink2)',lineHeight:1.7,margin:0}}>{desc}</p></div>
