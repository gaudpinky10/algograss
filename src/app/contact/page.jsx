      ...
      <div className="wrap" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:72}}>
        <div>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:20,marginBottom:36}}>
            {[{icon:'✉',label:'Email',val:'contact@algograss.com',href:'mailto:contact@algograss.com'},{icon:'📍',label:'Location',val:'United Kingdom'},{icon:'🕐',label:'Support hours',val:'Mon–Fri, 9am–6pm GMT'}].map(({icon,label,val,href})=>(
