...
const response = await fetch('https://www.algograss.co.uk/api/scan', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://www.algograss.co.uk/api/scan',
    headers={
        'Authorization': 'Bearer YOUR_API_KEY',
        'Content-Type': 'application/json',
    },
...
print(f"Issues: {len(result['issues'])}")`,
  ...
  cURL: `curl -X POST https://www.algograss.co.uk/api/scan \\
        ...
        <div style={S.card}>
          ...
          <div style={{ marginBottom: 20 }}>
            <div style={{ display: 'flex', gap: 8, marginBottom: 10, flexWrap: 'wrap' }}>
              ...
              <code style={{ color: '#0F172A', fontSize: 14 }}>https://www.algograss.co.uk/api/scan</code>
            </div>
