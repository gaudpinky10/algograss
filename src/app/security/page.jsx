...
const Row = ({ label, value, note }) => (
  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'flex-start', padding: '14px 0', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
    ...
    <div style={{ flex: 1 }}>
      ...
      {note && <span style={{ display: 'block', fontSize: 11, color: 'rgba(232,240,254,0.35)', marginTop: 3 }}>{note}</span>}
    </div>
  </div>
)
...
export default function SecurityPage() {
  return (
    <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(220px,1fr))', gap: 16, marginTop: 24 }}>
            {[
              ...
              <TiltCard key={title} intensity={6}>
                <div style={{ background: 'rgba(0,212,170,0.04)', border: '1px solid rgba(0,212,170,0.15)', borderRadius: 14, padding: '22px 20px' }}>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 14, padding: '22px 24px', marginTop: 24, fontFamily: 'monospace', fontSize: 12, lineHeight: 2, color: 'var(--ink2)', overflowX: 'auto' }}>
            {[
              ...
              <div key={h} style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginBottom: 4 }}>
                <span style={{ color: '#00D4AA', minWidth: 280, flexShrink: 0 }}>{h}:</span>
                <span style={{ color: 'rgba(232,240,254,0.45)', fontSize: 11 }}>{v}</span>
              </div>
            ))}
          </div>
        </AnimateOnScroll>
        ...
        <AnimateOnScroll>
          ...
          <div style={{ marginTop: 24 }}>
            {[
              ...
              <div key={name} style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'flex-start', padding: '14px 0', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <span style={{ display: 'block', fontSize: 11, color: 'rgba(232,240,254,0.35)', marginTop: 3 }}>📍 {location}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <AnimateOnScroll>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 14, marginTop: 24 }}>
            {[
              ...
              <div key={right} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 12, padding: '18px 16px' }}>
      ...
      {/* Contact */}
      <section style={{ padding: '72px 0', background: 'rgba(13,21,37,0.8)', borderTop: '1px solid rgba(255,255,255,0.05)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
