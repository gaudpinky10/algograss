          ...
          <div style={{background:'var(--bg2)',border:'1px solid var(--border)',borderRadius:18,padding:'32px 36px',marginBottom:20}}>
            ...
            {step===4 && <>
              ...
              <div style={{display:'flex',flexDirection:'column',gap:8,marginBottom:20}}>
                {RISK_ITEMS.map(r=>(
                  <label key={r} style={{display:'flex',alignItems:'center',gap:10,padding:'12px 16px',background:form.risks.includes(r)?'rgba(239,68,68,0.08)':'rgba(15,23,42,0.02)',border:`1px solid ${form.risks.includes(r)?'rgba(239,68,68,0.3)':'var(--border)'}`,borderRadius:10,cursor:'pointer',transition:'all .15s'}}>
            ...
            {step===6 && <>
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:14,marginBottom:24}}>
                {[
                  ...
                  <div key={k} style={{background:'rgba(15,23,42,0.03)',border:'1px solid var(--border)',borderRadius:10,padding:'12px 16px'}}>
